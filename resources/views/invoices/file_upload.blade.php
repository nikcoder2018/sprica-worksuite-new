...
<div class="modal-body">
    <x-form id="createTaskCategory">
        ...
        <div class="row">
            <div class="col-lg-12">
                <x-forms.file allowedFileExtensions="png jpg jpeg" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.projects.uploadFile')"
                    fieldName="file" fieldId="invoice-file" />
            </div>
        </div>
    </x-form>
</div>
