            ...
            <x-slot name="buttons">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <x-forms.button-primary icon="users-cog" id="add-role" class="mb-2"> @lang('modules.roles.addRole')
            ...
            <div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100">
                @forelse($roles as $role)
                    <div class="d-flex justify-content-between border rounded my-3 px-4 py-2 align-items-center">
                        <div>
                            <div class="heading-h4">{{ ucwords($role->display_name) }}</div>
                            <div class="simple-text text-lightest mt-1">{{ $role->roleuser_count }} @lang('app.member')
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="table-sm-responsive role-permissions" id="role-permission-{{ $role->id }}">
                    </div>
                @empty
                @endforelse
            </div>
