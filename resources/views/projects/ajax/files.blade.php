...
<div class="tab-pane fade show active mt-5" role="tabpanel" aria-labelledby="nav-email-tab">
    ...
    <x-cards.data :title="__('modules.projects.files')">
        ...
        @if (($addFilePermission == 'all' || $addFilePermission == 'added') && !$project->trashed())
            ...
            <x-form id="save-taskfile-data-form" class="d-none">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <x-forms.file-multiple fieldLabel="" fieldName="file" fieldId="employee_file" />
                    </div>
                    <div class="col-md-12">
...
<script>
    ...
    if (!trashed && (add_project_files == "all" || add_project_files == "added")) {
