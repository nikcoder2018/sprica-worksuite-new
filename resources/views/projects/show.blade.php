...
$viewProjectMilestonePermission = user()->permission('view_project_milestones');
        ...
        <div class="project-menu" id="mob-client-detail">
            ...
            <nav class="tabs">
                <ul class="-primary">
                    ...
                    @if ($viewProjectMilestonePermission == 'all' || ($viewProjectMilestonePermission == 'added' && user()->id == $project->added_by) || ($viewProjectMilestonePermission == 'owned' && user()->id == $project->client_id))
                        <li>
                    ...
                    @if (in_array('payments', user_modules()) && ($viewPaymentPermission == 'all' || ($viewPaymentPermission == 'added' && user()->id == $project->added_by) || ($viewPaymentPermission == 'owned' && user()->id == $project->client_id)))
                        <li>
                    ...
                    @if ($viewNotePermission == 'all' || $viewNotePermission == 'added')
                        <li>
