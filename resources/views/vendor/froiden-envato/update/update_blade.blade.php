                ...
                <div class=" alert alert-danger">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <x-forms.link-primary class="mr-3" :link="config('froiden_envato.envato_product_url')" icon="shopping-cart">Renew support now</x-forms.link-primary>

                            <x-forms.link-secondary link="javascript:;" onclick="getPurchaseData();" icon="sync-alt">Refresh</x-forms.link-secondary>
                ...
                <div class="alert alert-info">
                    <div class="row">
                        ...
                        @if(\Carbon\Carbon::parse($envatoUpdateCompanySetting->supported_until)->diffInDays() < 30)
                            <div class="col-md-6 text-right">
                                <x-forms.link-primary class="mr-3" :link="config('froiden_envato.envato_product_url')" icon="shopping-cart">Extend Now</x-forms.link-primary>
        ...
        <div class="note alert alert-primary">
            <div class="row p-20" style="line-height: 22px">
                <div class="col-md-8">
                    ...
                    <div class="mt-3"><span class="font-weight-bold text-red">Note:</span> You will get logged
                ...
                <div class="col-md-4 text-right mt-3">
                    <x-forms.link-primary id="update-app" link="javascript:;" icon="download">@lang('modules.update.updateNow')</x-forms.link-primary>
                </div>
            </div>

            <div class="col-md-12 mt-5">
                <h6 class="update-summary-title"><i
                        class="fa fa-history f-20"></i> Update Summary</h6>
