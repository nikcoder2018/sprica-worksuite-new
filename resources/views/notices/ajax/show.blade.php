            ...
            <div class="card bg-white border-0 b-shadow-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-2 text-right">
                            @if (
                                ...
                                && (($editPermission == 'all' || ($editPermission == 'added' && $notice->added_by == user()->id))
                                || ($deletePermission == 'all' || ($deletePermission == 'added' && $notice->added_by == user()->id)))
                            )
                                <div class="dropdown">
                                    <button
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                        ...
                                        @if ($editPermission == 'all' || ($editPermission == 'added' && $notice->added_by == user()->id))
                                            <a class="dropdown-item openRightModal"
                                                href="{{ route('notices.edit', $notice->id) }}">@lang('app.edit')</a>
                                        @endif
                                        @if ($deletePermission == 'all' || ($deletePermission == 'added' && $notice->added_by == user()->id))
                ...
                <div class="card-body">
                    ...
                    <x-cards.data-row :label="__('app.date')"
                        :value="$notice->created_at->format($global->date_format)" />

                    <x-cards.data-row :label="__('app.to')" :value="__('app.'.$notice->to)" />

                    <x-cards.data-row :label="__('app.description')" :value="$notice->description" html="true" />
