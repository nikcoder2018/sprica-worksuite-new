...
class NoticeController extends AccountBaseController
{
    ...
    public function edit($id)
    {
        ...
        abort_403(!($this->editPermission == 'all' || ($this->editPermission == 'added' && $this->notice->added_by == user()->id)));
    ...
    public function destroy($id)
    {
        ...
        abort_403(!($this->deletePermission == 'all' || ($this->deletePermission == 'added' && $notice->added_by == user()->id)));
